...
import MealList from './features/meal/MealList'
...
const sidebarNavigation = [
  {name: 'Meals', href: '/meals', icon: HomeIcon, current: false, component: MealList},
  {name: 'Ingredients', href: '/ingredients', icon: BeakerIcon, current: false, component: IngredientList},
  {name: 'Calendar', href: '/calendar', icon: CalendarIcon, current: false, component: Calendar},
]
...
function App() {
  ...
  function getSidebarNavigation() {
    return sidebarNavigation.map((item) => (
      <Link
        to={item.href}>
        <div
          key={item.name}
